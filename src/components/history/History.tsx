...
const History: React.FC<HistoryProps> = ({
  ...
  const [loadingPrHistoryItemId, setLoadingPrHistoryItemId] = React.useState<number | null>(null);
  ...
  const handlePRHistoryItemClick = async (analysisid: number) => {
    try {
      setLoadingPrHistoryItemId(analysisid);
      ...
      setLoadingPrHistoryItemId(null);
    }
  };
  ...
  const refreshHistory = async () => {
    try {
      ...
      await Promise.all([refetchHistory(), refetchPrHistory()]);
    } finally {
              ...
              <>
                {prLoading || manualLoading ? (
                  ...
                  prHistoryData.analysis_history.map((item: any) => (
                    ...
                    >
                      {loadingPrHistoryItemId === item.id ? (
